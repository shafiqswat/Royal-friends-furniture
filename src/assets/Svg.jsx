...
// Briefcase Icon
export const BriefcaseIcon = ({ className = "w-6 h-6", fill = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill={fill}>
...
// Wrench Icon
export const WrenchIcon = ({ className = "w-6 h-6", fill = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill={fill}>
...
// Dollar Sign Icon
export const DollarSignIcon = ({ className = "w-6 h-6", fill = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill={fill}>
...
// Map Pin Icon
export const MapPinIcon = ({ className = "w-5 h-5", fill = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill={fill}>
...
// Arrow Right Icon
export const ArrowRightIcon = ({ className = "w-5 h-5", fill = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill={fill}>
